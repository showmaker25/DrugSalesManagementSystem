...
<div id="main">
	...
	<div id="top">
		<table cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				<td><div id="t_left"><span class="sp1 sp2">销售管理</span></div></td>
  ...
  <script  src="tiptip.js" language="javascript"  type="text/javascript"></script>
    <td width="90" height="88" style="background:url(img/bill.jpg) no-repeat"><a onclick="display5();"">销售订货单</a></td>
    <td><img src="img/jh/a_1.jpg" width="101" height="29"></td>
    <td width="300" height="88" style="background:url(img/bill.jpg) no-repeat"><a onclick="display5();">收款单</a></td>
