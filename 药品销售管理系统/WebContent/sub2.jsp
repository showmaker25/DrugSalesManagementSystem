...
<div id="main">
	...
	<div id="top">
		<table cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				<td><div id="t_left"><span class="sp1 sp2">进货管理</span></div></td>
			</tr>
		</table>
	</div>
	<table cellpadding="0" cellspacing="0" style="width:100%;">
			<tr>
				<td valign="top" style="text-align:center;">
					...
					<div id="content">
	<table width="506" border="0" cellspacing="0" cellpadding="0" id="tb2">
  <tr>
  <script  src="control1.js" language="javascript"  type="text/javascript"></script>
  <script  src="tiptip.js" language="javascript"  type="text/javascript"></script>
    <td width="90" height="88" style="background:url(img/bill.jpg) no-repeat"><a onclick="display6();">采购订货单</a></td>
    <td><img src="img/jh/a_1.jpg" width="101" height="29"></td>
    <td width="300" height="88" style="background:url(img/bill.jpg) no-repeat"><a onclick="display5();">付款单</a></td>
